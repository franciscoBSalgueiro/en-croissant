...
export default function GameSelector({ id, headers }: { id: string, headers: GameHeaders }) {
    ...
    async function loadMoreRows({ startIndex, stopIndex }: { startIndex: number, stopIndex: number }) {
    ...
    return <>
        <Accordion>
            <Accordion.Item value="customization">
                <Accordion.Control>{formatNumber(activePage + 1)}. {headers.event.name}</Accordion.Control>
