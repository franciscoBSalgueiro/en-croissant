...
export const commands = {
  ...
  async getBestMoves(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_best_moves", { id, engine, tab, goMode, options }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async analyzeGame(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("analyze_game", { id, engine, goMode, options, uciOptions }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getPuzzle(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_puzzle", { file, minRating, maxRating, theme }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async mergePlayers(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("merge_players", { file, player1, player2 }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async convertPgn(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("convert_pgn", { files, dbPath, timestamp, title, description }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async editDbInfo(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("edit_db_info", { file, title, description }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async downloadFile(
    ...
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("download_file", { id, url, path, token, finalize, totalSize }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
  ...
  async getThemesForPuzzle(file: string, puzzleId: number): Promise<Result<string[], string>> {
    try {
      return {
        status: "ok",
        data: await TAURI_INVOKE("get_themes_for_puzzle", { file, puzzleId }),
      };
    } catch (e) {
      if (e instanceof Error) throw e;
      else return { status: "error", error: e as any };
...
export type Player = { name: string | null; elo: number | null };
export type PlayerConfig =
  | { type: "human"; name: string }
  | { type: "engine"; name: string; path: string; options?: EngineOption[]; go: GoMode | null };
...
export type PlayerSort = "name" | "elo";
