...
export const commands = {
    async closeSplashscreen(): Promise<Result<null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("close_splashscreen"),
            };
        } catch (e) {
    ...
    ): Promise<Result<[number, BestMoves[]] | null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_best_moves", {
                    id,
                    engine,
                    tab,
                    goMode,
    ...
    ): Promise<Result<MoveAnalysis[], string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("analyze_game", {
                    id,
                    engine,
                    goMode,
                    options,
    ...
    async cancelAnalysis(id: string): Promise<Result<null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("cancel_analysis", { id }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async stopEngine(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("stop_engine", { engine, tab }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async killEngine(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("kill_engine", { engine, tab }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async killEngines(tab: string): Promise<Result<null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("kill_engines", { tab }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getEngineLogs(
        engine: string,
        tab: string,
    ): Promise<Result<EngineLog[], string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_engine_logs", { engine, tab }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getPuzzle(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_puzzle", {
                    file,
                    minRating,
                    maxRating,
                    theme,
    ...
    async searchOpeningName(
        query: string,
    ): Promise<Result<OutOpening[], string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("search_opening_name", { query }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getOpeningFromFen(fen: string): Promise<Result<string, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_opening_from_fen", { fen }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getOpeningFromFens(fens: string[]): Promise<Result<string, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_opening_from_fens", { fens }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getOpeningFromName(name: string): Promise<Result<string, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_opening_from_name", { name }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getPlayersGameInfo(
        file: string,
        id: number,
    ): Promise<Result<PlayerGameInfo, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_players_game_info", { file, id }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getEngineConfig(path: string): Promise<Result<EngineConfig, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_engine_config", { path }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async fileExists(path: string): Promise<Result<boolean, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("file_exists", { path }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getFileMetadata(path: string): Promise<Result<FileMetadata, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_file_metadata", { path }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async mergePlayers(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("merge_players", {
                    file,
                    player1,
                    player2,
                }),
    ...
    async convertPgn(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("convert_pgn", {
                    files,
                    dbPath,
                    timestamp,
                    title,
    ...
    async getPlayer(
        file: string,
        id: number,
    ): Promise<Result<Player | null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_player", { file, id }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async countPgnGames(file: string): Promise<Result<number, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("count_pgn_games", { file }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async readGames(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("read_games", { file, start, end }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async lexPgn(pgn: string): Promise<Result<Token[], string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("lex_pgn", { pgn }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async deleteGame(file: string, n: number): Promise<Result<null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("delete_game", { file, n }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async deleteDuplicatedGames(file: string): Promise<Result<null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("delete_duplicated_games", { file }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async deleteEmptyGames(file: string): Promise<Result<null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("delete_empty_games", { file }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async setFileAsExecutable(path: string): Promise<Result<null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("set_file_as_executable", { path }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async deleteIndexes(file: string): Promise<Result<null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("delete_indexes", { file }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async createIndexes(file: string): Promise<Result<null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("create_indexes", { file }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async editDbInfo(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("edit_db_info", {
                    file,
                    title,
                    description,
                }),
    ...
    async deleteDbGame(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("delete_db_game", { file, gameId }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async writeDbGame(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("write_db_game", {
                    file,
                    gameId,
                    pgn,
                }),
    ...
    async deleteDatabase(file: string): Promise<Result<null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("delete_database", { file }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async exportToPgn(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("export_to_pgn", { file, destFile }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async authenticate(username: string): Promise<Result<null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("authenticate", { username }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async writeGame(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("write_game", { filePath, n, pgn }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async downloadFile(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("download_file", {
                    id,
                    url,
                    path,
                    token,
    ...
    ): Promise<Result<QueryResponse<Event[]>, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_tournaments", { file, query }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getDbInfo(file: string): Promise<Result<DatabaseInfo, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_db_info", { file }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getGames(
        file: string,
        query: GameQuery,
    ): Promise<Result<QueryResponse<NormalizedGame[]>, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_games", { file, query }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async searchPosition(
        ...
        query: GameQuery,
        tabId: string,
    ): Promise<Result<[PositionStats[], NormalizedGame[]], string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("search_position", {
                    file,
                    query,
                    tabId,
                }),
    ...
    async getPlayers(
        file: string,
        query: PlayerQuery,
    ): Promise<Result<QueryResponse<Player[]>, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_players", { file, query }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getPuzzleDbInfo(
        file: string,
    ): Promise<Result<PuzzleDatabaseInfo, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_puzzle_db_info", { file }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getPuzzleThemes(file: string): Promise<Result<string[], string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_puzzle_themes", { file }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getThemesForPuzzle(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_themes_for_puzzle", {
                    file,
                    puzzleId,
                }),
            };
    ...
    async deletePuzzleDatabase(file: string): Promise<Result<null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("delete_puzzle_database", { file }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getPuzzleSessions(): Promise<Result<SavedPuzzleSession[], string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_puzzle_sessions"),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async setPuzzleSessions(
        sessions: SavedPuzzleSession[],
    ): Promise<Result<null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("set_puzzle_sessions", { sessions }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async startGame(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("start_game", { gameId, config }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getGameState(gameId: string): Promise<Result<GameState, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_game_state", { gameId }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async makeGameMove(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("make_game_move", { gameId, uci }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async takeBackGameMove(gameId: string): Promise<Result<GameState, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("take_back_game_move", { gameId }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async resignGame(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("resign_game", { gameId, color }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async abortGame(gameId: string): Promise<Result<null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("abort_game", { gameId }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getGameEngineLogs(
        ...
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_game_engine_logs", {
                    gameId,
                    color,
                }),
            };
    ...
    async preloadReferenceDb(file: string): Promise<Result<null, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("preload_reference_db", { file }),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
    ...
    async getSoundServerPort(): Promise<Result<number, string>> {
        try {
            return {
                status: "ok",
                data: await TAURI_INVOKE("get_sound_server_port"),
            };
        } catch (e) {
            if (e instanceof Error) throw e;
            else return { status: "error", error: e as any };
...
export type ClockUpdateEvent = {
    gameId: string;
    whiteTime: bigint | null;
    blackTime: bigint | null;
};
...
export type GameResult =
    | { type: "whiteWins"; reason: GameEndReason }
    | { type: "blackWins"; reason: GameEndReason }
...
export type SavedPuzzleSession = {
    id: string;
    name: string;
    savedAt: number;
