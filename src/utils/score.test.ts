...
describe("getWinChance", () => {
    it("should calculate the win chance correctly", () => {
        ...
        expect(getWinChance(100)).toBeCloseTo(59.10);
...
describe("getCPLoss", () => {
    it("should calculate the centipawn loss correctly", () => {
        expect(getCPLoss({ type: "cp", value: 0 }, { type: "cp", value: 50 }, "b")).toEqual(50);
        expect(getCPLoss({ type: "mate", value: -1 }, { type: "cp", value: 0 }, "b")).toEqual(1000);
    });
});