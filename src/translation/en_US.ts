export const en_US = {
  translation: {
    ...
    "Board.Analysis.Review": "Review",
    "Review.GenerateReview": "Generate review",
    "Review.RegenerateReview": "Regenerate review",
    "Review.ReviewGenerated": "Review generated",
    "Review.AnalysingGame": "Analysing game",
    "Review.RunReportFirst": "Run report analysis first",
    "Review.NoEngineConfigured": "No engine configured. Add one in Settings.",
    "Review.NoMovesToAnalyse": "No moves to analyse",
    "Review.MoveByMove": "Move by move",
    "Review.StepThrough": "Navigate mistakes",
    "Review.FirstMistake": "First mistake",
    "Review.PreviousMistake": "Previous mistake",
    "Review.NextMistake": "Next mistake",
    "Review.LastMistake": "Last mistake",
    "Review.Best": "Best",
