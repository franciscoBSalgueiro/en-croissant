export const en_US = {
  translation: {
    ...
    "Engines.Remove.Message":
      "Are you sure you want to remove this engine from Botvinnik?",
    ...
    "Settings.ArrowColorMode": "Arrow Color Mode",
    "Settings.ArrowColorMode.Desc": "Color arrows by engine or move quality",
    "Settings.ArrowColorMode.Engine": "By Engine",
    "Settings.ArrowColorMode.Quality": "By Move Quality",
    ...
    "Settings.Anarchy.ForcedEnCroissant": "Forced Botvinnik",
    "Settings.Anarchy.ForcedEnCroissant.Desc":
      "Forces you to play Botvinnik, if it's a legal move.",
