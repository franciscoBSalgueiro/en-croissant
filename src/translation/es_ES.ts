export const es_ES = {
  translation: {
    ...
    "Common.RequirePath": "La ruta es obligatória",
    "Common.PGNFile": "Fichero PGN",
    "Common.PGNGame": "Juego PGN",
    "Common.Size": "Tamaño",
    ...
    "Engines.Settings.Reset": "Valores predeterminados",
    ...
    "Databases.Delete.Message":
      "Éstas seguro de que quieres eliminar esta base de datos?",
    ...
    "Settings.ConsecutiveArrows.Desc":
      "Muestra varias flechas para la mejor línea, si implica mover la misma pieza varias veces",
