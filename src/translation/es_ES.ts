export const es_ES = {
  translation: {
    ...
    "Engines.Remove.Message":
      "¿Está seguro de que desea eliminar este motor de Botvinnik?",
    ...
    "Settings.Anarchy.ForcedEnCroissant": "Forzar Botvinnik",
    "Settings.Anarchy.ForcedEnCroissant.Desc":
      "Forzar a jugar Botvinnik, si es un movimiento legal.",
